        ...
        <form method="POST" action="{{route('stok.send')}}">
            ...
            <div>
                ...
                <div class="mt-6 pb-4 border-b border-gray-200">
                    ...
                    <input type="radio" name="status" value="company" id="company" checked><label for="company">会社について詳しく知りたい</label><br>
                    <input class="mt-2" type="radio" name="status" value="request" id="request"><label for="request">お仕事依頼</label><br>
                    <input class="mt-2" type="radio" name="status" value="talk" id="talk"><label for="talk">社長とお話ししたい</label><br>
                    <input class="mt-2" type="radio" name="status" value="conf" id="conf"><label for="conf">ご相談</label><br>
                    <input class="mt-2" type="radio" name="status" value="requ" id="requ"><label for="requ">採用について</label><br>
                    <input class="mt-2" type="radio" name="status" value="others" id="others"><label for="others">その他</label><br>
                </div>
